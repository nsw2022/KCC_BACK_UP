...
public class BoardDTO implements Serializable {
	...
	public BoardDTO(String title, String pname, String pw, String upfile, String content, Date reg_date, int id,
			int cnt, int seq, int lev, int gid, SimpleDateFormat sdf) {
		super();
		this.title = title;
		this.pname = pname;
		this.pw = pw;
